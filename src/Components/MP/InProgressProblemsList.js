...
export default class InProgressProblemsList extends Component {
  static navigationOptions = {
    header: null,
  };
  constructor(props) {
    super();
    console.log(`LISt state ${JSON.stringify(this.props)}`);
    this.state = {
      expanded: false,
      addedComment: null,
    };
        ...
        <TouchableWithoutFeedback onPress={this.onPress}>
          <View style={styles.touchableStyle}>
            <View style={styles.problemHeader}>
              ...
              <Button title="Roadmap" onPress={() => this.props.navigation.navigate('Roadmap')} />
            </View>
            <View>
              {!this.state.expanded && (
                <Icon
